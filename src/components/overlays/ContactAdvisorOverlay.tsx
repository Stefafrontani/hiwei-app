  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-4">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex flex-col gap-1.5">
          <Label className="text-[12px] font-semibold text-[#18181B]">Teléfono *</Label>
          <Input
            value={phone}
        ...
        <div className="flex flex-col gap-1.5">
          <Label className="text-[12px] font-medium text-[#71717A]">Consulta (opcional)</Label>
          <textarea
            value={query}
            onChange={(e) => setQuery(e.target.value)}
            placeholder="Escribí tu consulta..."
            rows={3}
            className="rounded-[10px] border border-[#E4E4E7] px-3.5 py-3 text-[13px] text-[#18181B] placeholder:text-[#A1A1AA] focus:outline-none focus:ring-2 focus:ring-[#2563EB]/30 resize-none"
          />
        </div>
      </div>
