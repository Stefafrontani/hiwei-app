        ...
        <div className="fixed inset-0 z-40 flex flex-col bg-black">
          ...
          <div className="flex flex-1 flex-col md:flex-row items-stretch gap-1 px-1 pb-1">
            <ComparatorPlayerCard
              ...
              variant="immersive"
              onFullscreenChange={(fs) => setFullscreenSide(fs ? 'A' : null)}
              siblingFullscreen={fullscreenSide === 'B'}
            />
            <ComparatorPlayerCard
              product={productB}
              activeAngle={activeAngle}
              ...
              playbackKey={playbackKey}
              variant="immersive"
              onFullscreenChange={(fs) => setFullscreenSide(fs ? 'B' : null)}
              siblingFullscreen={fullscreenSide === 'A'}
            />
          </div>
        </div>
      )}
