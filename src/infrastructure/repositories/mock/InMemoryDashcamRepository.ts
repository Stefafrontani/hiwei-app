...
const PRODUCTS: DashcamProduct[] = [
  ...
  },
  {
    ...
    features: ['Cámara frontal 2K QHD', 'Cámara trasera Full HD 1080p', 'Pantalla táctil IPS 3"', 'Wi-Fi integrado', 'Modo estacionamiento', 'Control Bluetooth incluido'],
  ...
  },
  {
    ...
    features: ['Cámara frontal 4K Ultra HD', 'Cámara trasera Full HD 1080p', 'Cámara interior HD', 'GPS integrado', 'Modo estacionamiento 24hs', 'Control Bluetooth'],
  ...
  },
  {
    ...
    features: ['Resolución Full HD 1080p', 'Ángulo de 140°', 'Sensor de noche WDR', 'G-Sensor integrado', 'App móvil incluida'],
  ...
  },
  {
    ...
    features: ['Resolución HD 720p', 'Ángulo de 120°', 'Grabación en bucle automática', 'Instalación plug & play'],
